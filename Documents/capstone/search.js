...
let tex = document.getElementsByClassName("textmessage")[0]
...
for (let i = 0; i < properties.length; i++) {
    ...
    det.innerHTML += `<div class="product"</div>
...
btn.addEventListener("click", function () {
    console.log("Click");
    let propn = document.getElementById("propn").value
    let loca = document.getElementById("loca").value
    let type = document.getElementById("type").value
    let area = document.getElementById("area").value
    let price = document.getElementById("price").value
    let image = document.getElementById("image").value
    if (propn != "" && loca != "" && type != "" && area != "" && price != "" && image != "") {
        det.innerHTML += `<div class="product"</div>
 <img src="${image}">
    <p><b>Name of the property: </b>${propn}</p>
     <p><b>Location: </b>${loca}</p>
      <p><b>Type of the property: </b>${type}</p>
      <p><b>Area:</b> ${area}</p>
       <p><b>Price: </b>${price}</p>
       ` }
    else {
        ...
        error.innerText = "Don't leave the black space and  enter the correct details  "
...
reset.addEventListener("click", function () {
    let propn = document.getElementById("propn")
